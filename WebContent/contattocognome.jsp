...
<title>Risultati ricerca con cognome</title>
</head>
<style type="text/css">
td {border: 1px solid black;}
table {border-collapse: collapse; border: 1px solid black; background: lime; width: 100%}
</style>
<body>
	<h1>LISTA CONTATTI BY COGNOME INSERITO</h1>
